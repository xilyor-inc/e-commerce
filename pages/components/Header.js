      ...
      <div className={styles.container}>
        {/* <div className={styles.topLinks}>
          ...
          <ul className={`${styles.linksList} ${isMenuOpen ? styles.open : ''}`}>
            <li><Link href="#"><div>Siparişlerim</div></Link></li>
            <li><Link href="#"><div>Süper Fiyat, Süper Teklif</div></Link></li>
            <li><Link href="#"><div>Yurd Dışından</div></Link></li>
            <li><Link href="#"><div>Kampanyalar</div></Link></li>
            <li><Link href="#"><div className={styles.highlight}>Girişimci Kadınlar</div></Link></li>
            <li><Link href="#"><div>Müşteri Hizmetleri</div></Link></li>
            <li><Link href="#"><div className={styles.highlight}>Hepsiburada Premium</div></Link></li>
            <li><Link href="#"><div>Hepsiburada'da Satıcı Ol</div></Link></li>
          </ul>
        </div> */}
        ...
        <div className={styles.mainHeader}>
          <div className={styles.logoArea}>
            ...
            <div className={styles.premiumText}><span>Premium'u</span> keşfet</div>
          </div>
          
          <div className={styles.searchArea}>
            <div className={styles.searchInputGroup}>
              <input type="text" className={styles.searchInput} placeholder="Ürün, kategori veya marka ara" />
              <i className={`bi bi-search ${styles.searchIcon}`}></i>
              <button className={styles.searchButton} type="button">ARA</button>
            </div>
          </div>
          ...
          <div className={styles.userActions}>
            <Dropdown className={styles.locationDropdown}>
              <Dropdown.Toggle variant="light" id="dropdown-basic">
                ...
                <span>Konum</span>
                <span className={styles.locationSubtext}>İş</span>
              </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item>
                  <h5>Konumunuzu Belirleyin</h5>
                  <p>Adresinizi veya konum bilgilerinizi seçerek özel hizmetleri görebilirsiniz.</p>
                  <button className={styles.newLocationButton}>Yeni Konum Seç</button>
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
