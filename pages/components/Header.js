      ...
      <div className={styles.container}>
        <div className={styles.mainHeader}>
          <div className={styles.logoArea}>
            {/* SVG logo would go here */}  <svg width="191" height="34" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171 28">
          ...
          <div className={styles.userActions}>
            <Dropdown className={styles.locationDropdown}>
              <Dropdown.Toggle variant="light" id="dropdown-basic">
                ...
                <span className={styles.hideOnMobile}>Konum</span>
            ...
            <button className={styles.cartButton}>
              ...
              <span className={styles.hideOnMobile}>Mon panier</span>
            </button>
          </div>
        </div>
