...
const Header = () => {
  const popover = (
    <Popover id="popover-basic">
      <Popover.Header as="h3">Açılır Menü</Popover.Header>
      <Popover.Body>
        Javascript ile düzenlenebilir
      </Popover.Body>
    </Popover>
  );
  ...
  return (
    <header>
      <div id="header-container" className="container-xxlg">
        <div id="header-row1" className="row g-2">
          <div className="col py-2">
            <ul id="top-links">
              <li><Link href="#" title="Siparişlerim">Siparişlerim</Link></li>
              <li><Link href="#" title="Süper Fiyat, Süper Teklif">Süper Fiyat, Süper Teklif</Link></li>
              <li><Link href="#" title="Yurd Dışından">Yurd Dışından</Link></li>
              <li><Link href="#" title="Kampanyalar">Kampanyalar</Link></li>
              <li><Link href="#" title="Girişimci Kadınlar" style={{ color: '#FF6000' }}>Girişimci Kadınlar</Link></li>
              <li><Link href="#" title="Müşteri Hizmetleri">Müşteri Hizmetleri</Link></li>
              <li><Link href="#" title="Hepsiburada Premium" style={{ color: '#FF6000' }}>Hepsiburada Premium</Link></li>
              <li><Link href="#" title="Hepsiburada'da Satıcı Ol">Hepsiburada'da Satıcı Ol</Link></li>
            </ul>
          </div>
        </div>
        <div id="header-row2" className="row g-2">
          ...
          <div id="header-col2" className="col-4">
            <div id="header-col2-search" className="input-group mb-3 position-relative">
              ...
              <ul id="header-col2-search-dropdown" className="dropdown-menu dropdown-menu-start p-3">
                <li>
                  <h5 className="fs-6">Arama Alanı</h5>
                  <p>Aramaya başlamak için en az 2 karakter yazmalısınız</p>
                  <Image src="/images/calendar-heart.svg" width={120} height={120} alt="" />
                </li>
                <li>
                  <h5 className="fs-6">Arama Alanı</h5>
                  <p>Aramaya başlamak için en az 2 karakter yazmalısınız</p>
          ...
          <div id="header-col3" className="col-5">
            <Dropdown id="konum-dropdown">
              <Dropdown.Toggle variant="light" id="dropdown-basic">
                <div id="header-col3-geo-area">
                  <i className="bi bi-geo-alt"></i>
                  <div className="geo-area-button">
                    <p>Konum</p>
                    <p className="p-renk">İş</p>
                  </div>
              ...
              <Dropdown.Menu>
                <Dropdown.Item>
                  <h5 className="fs-6">Konumunuzu Belirleyin</h5>
                  <p>Adresinizi veya konum bilgilerinizi seçerek özel hizmetleri görebilirsiniz.</p>
                  <button className="btn btn-secondary justify-content-center orange-button">Yeni Konum Seç</button>
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>

            <OverlayTrigger trigger="click" placement="bottom" overlay={popover}>
              <div id="popover" className="col position-relative">
                <i className="bi bi-person"></i>
                <a href="#" title="popover"> 
                  <strong>Giriş Yap</strong> <br /><span>veya üye ol</span>
                </a>
                <i className="bi bi-caret-down-fill"></i>
              </div>
            </OverlayTrigger>

            <div id="geo-area-out" className="col position-relative">
              <button type="button" className="btn btn-secondary position-relative">
                <i className="bi bi-cart"></i>
                <span className="badge text-bg-light position-absolute badge-mine">4</span> Sepetim
              </button>
            </div>
          </div>
        </div>
